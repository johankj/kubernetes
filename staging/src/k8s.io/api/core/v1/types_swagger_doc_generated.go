...
var map_EvictionInterceptor = map[string]string{
	"":     "EvictionInterceptor allows you to specify the interceptor responding to the EvictionRequest. Interceptors should observe and communicate through the EvictionRequest API to help with the graceful eviction of a target (e.g. termination of a pod).",
