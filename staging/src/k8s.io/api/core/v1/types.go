...
type PodSpec struct {
	...
	// +listType=map
	// +listMapKey=name
	EvictionInterceptors []EvictionInterceptor `json:"evictionInterceptors,omitempty" patchStrategy:"merge" patchMergeKey:"name" protobuf:"bytes,44,rep,name=evictionInterceptors"`
}
...
// EvictionInterceptor allows you to specify the interceptor responding to the EvictionRequest.
// Interceptors should observe and communicate through the EvictionRequest API to help with
