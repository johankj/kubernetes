...
func (m *InterceptorStatus) Reset() { *m = InterceptorStatus{} }

func (m *LocalTargetReference) Reset() { *m = LocalTargetReference{} }

func (m *Requester) Reset() { *m = Requester{} }

func (m *TargetInterceptor) Reset() { *m = TargetInterceptor{} }
...
func (m *EvictionRequestStatus) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Interceptors) > 0 {
		for iNdEx := len(m.Interceptors) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.Interceptors[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if len(m.ProcessedInterceptors) > 0 {
		for iNdEx := len(m.ProcessedInterceptors) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.ProcessedInterceptors[iNdEx])
			copy(dAtA[i:], m.ProcessedInterceptors[iNdEx])
			i = encodeVarintGenerated(dAtA, i, uint64(len(m.ProcessedInterceptors[iNdEx])))
			i--
			dAtA[i] = 0x2a
		}
	}
	if len(m.ActiveInterceptors) > 0 {
		for iNdEx := len(m.ActiveInterceptors) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.ActiveInterceptors[iNdEx])
			copy(dAtA[i:], m.ActiveInterceptors[iNdEx])
			i = encodeVarintGenerated(dAtA, i, uint64(len(m.ActiveInterceptors[iNdEx])))
			i--
			dAtA[i] = 0x22
		}
	}
	if len(m.TargetInterceptors) > 0 {
		for iNdEx := len(m.TargetInterceptors) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.TargetInterceptors[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *InterceptorStatus) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *InterceptorStatus) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *InterceptorStatus) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *LocalTargetReference) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *LocalTargetReference) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *LocalTargetReference) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *TargetInterceptor) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *TargetInterceptor) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TargetInterceptor) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *EvictionRequestStatus) Size() (n int) {
	...
	if len(m.TargetInterceptors) > 0 {
		for _, e := range m.TargetInterceptors {
			l = e.Size()
			n += 1 + l + sovGenerated(uint64(l))
		}
	}
	if len(m.ActiveInterceptors) > 0 {
		for _, s := range m.ActiveInterceptors {
			l = len(s)
			n += 1 + l + sovGenerated(uint64(l))
		}
	}
	if len(m.ProcessedInterceptors) > 0 {
		for _, s := range m.ProcessedInterceptors {
			l = len(s)
			n += 1 + l + sovGenerated(uint64(l))
		}
	}
	if len(m.Interceptors) > 0 {
		for _, e := range m.Interceptors {
			l = e.Size()
			n += 1 + l + sovGenerated(uint64(l))
		}
	}
...
func (m *InterceptorStatus) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *LocalTargetReference) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *TargetInterceptor) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *EvictionRequestStatus) String() string {
	...
	repeatedStringForTargetInterceptors := "[]TargetInterceptor{"
	for _, f := range this.TargetInterceptors {
		repeatedStringForTargetInterceptors += strings.Replace(strings.Replace(f.String(), "TargetInterceptor", "TargetInterceptor", 1), `&`, ``, 1) + ","
	}
	repeatedStringForTargetInterceptors += "}"
	repeatedStringForInterceptors := "[]InterceptorStatus{"
	for _, f := range this.Interceptors {
		repeatedStringForInterceptors += strings.Replace(strings.Replace(f.String(), "InterceptorStatus", "InterceptorStatus", 1), `&`, ``, 1) + ","
	}
	repeatedStringForInterceptors += "}"
	s := strings.Join([]string{`&EvictionRequestStatus{`,
		`Conditions:` + repeatedStringForConditions + `,`,
		`ObservedGeneration:` + fmt.Sprintf("%v", this.ObservedGeneration) + `,`,
		`TargetInterceptors:` + repeatedStringForTargetInterceptors + `,`,
		`ActiveInterceptors:` + fmt.Sprintf("%v", this.ActiveInterceptors) + `,`,
		`ProcessedInterceptors:` + fmt.Sprintf("%v", this.ProcessedInterceptors) + `,`,
		`Interceptors:` + repeatedStringForInterceptors + `,`,
		`}`,
	}, "")
	return s
}
func (this *EvictionTarget) String() string {
	...
	s := strings.Join([]string{`&EvictionTarget{`,
		`Pod:` + strings.Replace(this.Pod.String(), "LocalTargetReference", "LocalTargetReference", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *InterceptorStatus) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&InterceptorStatus{`,
...
func (this *LocalTargetReference) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&LocalTargetReference{`,
		`Name:` + fmt.Sprintf("%v", this.Name) + `,`,
...
func (this *TargetInterceptor) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&TargetInterceptor{`,
		`Name:` + fmt.Sprintf("%v", this.Name) + `,`,
		`}`,
	}, "")
	return s
...
func (m *EvictionRequestStatus) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TargetInterceptors", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TargetInterceptors = append(m.TargetInterceptors, TargetInterceptor{})
			if err := m.TargetInterceptors[len(m.TargetInterceptors)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ActiveInterceptors", wireType)
			}
			...
			m.ActiveInterceptors = append(m.ActiveInterceptors, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ProcessedInterceptors", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ProcessedInterceptors = append(m.ProcessedInterceptors, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Interceptors", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Interceptors = append(m.Interceptors, InterceptorStatus{})
			if err := m.Interceptors[len(m.Interceptors)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *InterceptorStatus) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: InterceptorStatus: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: InterceptorStatus: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *LocalTargetReference) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: LocalTargetReference: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: LocalTargetReference: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *TargetInterceptor) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TargetInterceptor: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TargetInterceptor: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
