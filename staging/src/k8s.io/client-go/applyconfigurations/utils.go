...
func ForKind(kind schema.GroupVersionKind) interface{} {
	...
	case coordinationv1alpha1.SchemeGroupVersion.WithKind("TargetInterceptor"):
		return &applyconfigurationscoordinationv1alpha1.TargetInterceptorApplyConfiguration{}
