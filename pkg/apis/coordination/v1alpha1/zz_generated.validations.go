...
func Validate_EvictionRequest(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *coordinationv1alpha1.EvictionRequest) (errs field.ErrorList) {
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *v1.ObjectMeta, oldValueCorrelated bool) (errs field.ErrorList) {
			...
			func() { // cohort name
				errs = append(errs, validate.Subfield(ctx, op, fldPath, obj, oldObj, "name", func(o *v1.ObjectMeta) *string { return &o.Name }, validate.DirectEqualPtr, validate.UUID).MarkAlpha()...)
			}()
...
func Validate_EvictionRequestStatus(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *coordinationv1alpha1.EvictionRequestStatus) (errs field.ErrorList) {
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj []v1.Condition, oldValueCorrelated bool) (errs field.ErrorList) {
			...
			if e := validate.MaxItems(ctx, op, fldPath, obj, oldObj, 1000).MarkAlpha(); len(e) != 0 {
				errs = append(errs, e...)
				earlyReturn = true
			}
			if earlyReturn {
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj []coordinationv1alpha1.TargetInterceptor, oldValueCorrelated bool) (errs field.ErrorList) {
			// don't revalidate unchanged data
			if oldValueCorrelated && op.Type == operation.Update && equality.Semantic.DeepEqual(obj, oldObj) {
				return nil
			}
			...
			// lists with map semantics require unique keys
			errs = append(errs, validate.Unique(ctx, op, fldPath, obj, oldObj, func(a coordinationv1alpha1.TargetInterceptor, b coordinationv1alpha1.TargetInterceptor) bool {
				return a.Name == b.Name
			}).MarkAlpha()...)
			// iterate the list and call the type's validation function
			errs = append(errs, validate.EachSliceVal(ctx, op, fldPath, obj, oldObj, func(a coordinationv1alpha1.TargetInterceptor, b coordinationv1alpha1.TargetInterceptor) bool {
				return a.Name == b.Name
			}, validate.DirectEqual, Validate_TargetInterceptor)...)
			return
		}(fldPath.Child("targetInterceptors"), obj.TargetInterceptors, safe.Field(oldObj, func(oldObj *coordinationv1alpha1.EvictionRequestStatus) []coordinationv1alpha1.TargetInterceptor {
...
func Validate_EvictionTarget(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *coordinationv1alpha1.EvictionTarget) (errs field.ErrorList) {
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *coordinationv1alpha1.LocalTargetReference, oldValueCorrelated bool) (errs field.ErrorList) {
			...
			func() { // cohort name
				errs = append(errs, validate.Subfield(ctx, op, fldPath, obj, oldObj, "name", func(o *coordinationv1alpha1.LocalTargetReference) *string { return &o.Name }, validate.DirectEqualPtr, validate.LongName).MarkAlpha()...)
			}()
			// call the type's validation function
...
func Validate_InterceptorStatus(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *coordinationv1alpha1.InterceptorStatus) (errs field.ErrorList) {
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *v1.Time, oldValueCorrelated bool) (errs field.ErrorList) {
			...
			if e := validate.UpdatePointer(ctx, op, fldPath, obj, oldObj, validate.NoUnset, validate.NoModify).MarkAlpha(); len(e) != 0 {
				errs = append(errs, e...)
				earlyReturn = true
			}
			if earlyReturn {
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *string, oldValueCorrelated bool) (errs field.ErrorList) {
			...
			errs = append(errs, validate.MaxLength(ctx, op, fldPath, obj, oldObj, 4000).MarkAlpha()...)
			return
...
func Validate_LocalTargetReference(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *coordinationv1alpha1.LocalTargetReference) (errs field.ErrorList) {
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *types.UID, oldValueCorrelated bool) (errs field.ErrorList) {
			...
			return
		}(fldPath.Child("uid"), &obj.UID, safe.Field(oldObj, func(oldObj *coordinationv1alpha1.LocalTargetReference) *types.UID { return &oldObj.UID }), oldObj != nil)...)
...
// Validate_TargetInterceptor validates an instance of TargetInterceptor according
// to declarative validation rules in the API schema.
func Validate_TargetInterceptor(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *coordinationv1alpha1.TargetInterceptor) (errs field.ErrorList) {
	// field coordinationv1alpha1.TargetInterceptor.Name
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *string, oldValueCorrelated bool) (errs field.ErrorList) {
			// don't revalidate unchanged data
			if oldValueCorrelated && op.Type == operation.Update && (obj == oldObj || (obj != nil && oldObj != nil && *obj == *oldObj)) {
			...
			return
		}(fldPath.Child("name"), &obj.Name, safe.Field(oldObj, func(oldObj *coordinationv1alpha1.TargetInterceptor) *string { return &oldObj.Name }), oldObj != nil)...)
