...
func TestPrintEvictionRequest(t *testing.T) {
	...
	evictionRequest := coordination.EvictionRequest{
		...
		Status: coordination.EvictionRequestStatus{
			...
			TargetInterceptors: []coordination.TargetInterceptor{
				{Name: "interceptor1"},
				{Name: "interceptor2"},
			},
...
func TestPrintEvictionRequestList(t *testing.T) {
		...
		Items: []coordination.EvictionRequest{
...

			{
				...
				Status: coordination.EvictionRequestStatus{
					...
					ActiveInterceptors:    []string{},
					ProcessedInterceptors: []string{"interceptor1"},
					Interceptors: []coordination.InterceptorStatus{
						{Name: "interceptor1", HeartbeatTime: &metav1.Time{Time: dayAgo}, ExpectedCompletionTime: &metav1.Time{Time: dayAgo}, StartTime: &metav1.Time{Time: twoDaysAgo}, CompletionTime: nil, Message: "running for a long time"}},
					Conditions: []metav1.Condition{
						{Type: string(coordination.EvictionRequestConditionFailed), Status: metav1.ConditionTrue, ObservedGeneration: 1, LastTransitionTime: metav1.Time{Time: now}, Reason: string(coordination.EvictionRequestConditionReasonNoFurtherInterceptor), Message: "Canceled because there is no further interceptor."},
					},
				},
			},
			{
...

			{
				...
				Status: coordination.EvictionRequestStatus{
					...
					Interceptors: []coordination.InterceptorStatus{
						{Name: "interceptor1", HeartbeatTime: &metav1.Time{Time: dayAgo}, ExpectedCompletionTime: nil, StartTime: &metav1.Time{Time: twoDaysAgo}, CompletionTime: &metav1.Time{Time: dayAgo}, Message: "completed2"},
						{Name: "interceptor2", HeartbeatTime: &metav1.Time{Time: now}, ExpectedCompletionTime: &metav1.Time{Time: dayAgo}, StartTime: &metav1.Time{Time: now}, CompletionTime: nil, Message: "running2"},
					},
					Conditions: []metav1.Condition{
						{Type: string(coordination.EvictionRequestConditionEvicted), Status: metav1.ConditionFalse, ObservedGeneration: 1, LastTransitionTime: metav1.Time{Time: now}, Reason: "EvictionInProgress", Message: "Pod is being evicted."},
					},
	...
	expected := []metav1.TableRow{
		...
		{Cells: []interface{}{"5e153f5b-e420-41b4-9040-8f3b51cf2162", "pod2", "Pod", "Failed (NoFurtherInterceptor)", "interceptor1 (1/1)", "Canceled", "-", "drain.foo.com", "5d"}},
		{Cells: []interface{}{"a4ea9433-da6a-4bfc-9033-296488ba12be", "pod3", "Pod", "Failed (NoFurtherInterceptor)", "interceptor1 (1/1)", "Completed (4d ago)", "-", "drain.foo.com", "5d"}},
		{Cells: []interface{}{"68018c4c-bcca-4465-964a-66d8a1626686", "pod4", "Pod", "Failed (CanceledDueToNoRequesters)", "interceptor3 (1/2)", "Canceled", "-", "drain.foo.com", "5d"}},
		{Cells: []interface{}{"3d7fdff1-3fe5-48b9-b106-1ee24b0277f6", "pod5", "Pod", "Progressing", "interceptor2 (2/2)", "Started (3d ago)", "in 2d", "drain.foo.com", "5d"}},
		{Cells: []interface{}{"aac2a982-2176-4770-8c8c-bcdf51b24fde", "pod6", "Pod", "Progressing", "interceptor2 (2/2)", "Started (3d ago)", "4d ago", "drain.foo.com", "5d"}},
		{Cells: []interface{}{"707ba618-ffd6-4797-b503-17af1c7f4d98", "pod7", "Pod", "Progressing", "interceptor3 (1/2)", "Started (3d ago)", "<unknown>", "drain.foo.com + 1 more...", "5d"}},
		{Cells: []interface{}{"30741366-8d1f-4385-84ff-0f2e7ba0305f", "pod8", "Pod", "Progressing", "interceptor3 (1/2)", "Pending", "<unknown>", "drain.foo.com", "5d"}},
		{Cells: []interface{}{"36685829-9161-449a-b65a-2e63861fd9a8", "pod9", "Pod", "Progressing", "<unset> (0/2)", "Pending", "<unknown>", "drain.foo.com", "5d"}},
		{Cells: []interface{}{"9f4a1620-0e97-4246-b304-5969b2104377", "pod10", "Pod", "Failed (EvictionRequestInvalid)", "<unset> (0/2)", "Pending", "<unknown>", "drain.foo.com", "5d"}},
		{Cells: []interface{}{"e968f679-523b-4e63-9417-0cd9ae13a0b2", "pod11", "Pod", "Pending", "<unset> (0/0)", "Pending", "<unknown>", "<none>", "5d"}},
	}
