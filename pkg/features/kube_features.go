...
const (
	...
	//
	// Enables a new .spec.evictionInterceptos Pod field and an EvictionRequest Resource.
	// This can be used by a set of requesters and interceptors to coordinate graceful eviction of pods.
